...
| ----------------------------- | ------------------------- |
| [T-Display-AMOLED-Lite][1]    | [firmware](./firmware.bin) |
| [T-Display-S3 AMOLED][2]      | [firmware](./firmware.bin) |
| [T4-S3][3]                    | [firmware](./firmware.bin) |
| [T-Display-S3 AMOLED Plus][4] | [firmware](./firmware.bin) |
