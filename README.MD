<h1 align = "center">🌟LilyGO T-Display-AMOLED-Lite 🌟</h1> 
...
| -------------------------- | ---------- | ----- | -------- | ---------- |
| [T-Display-AMOLED-Lite][1] | ESP32-S3R8 | 16MB  | 8MB(OPI) | 194x368    |
...
├── GPS_Shield              # Extern GPS Shield example,use Serial communication
├── HP303BSensor            # Extern Temperature Pressure Sensor example,use Wire communication
├── LumenMeter              # AMOLED internal light sensor example
...
5. Open ArduinoIDE  , `File` -> `Examples` -> `T-Display-AMOLED-Lite` -> `Any Examples`
...
## 📽️ [Arduino IDE Video steps](https://www.baodi.com)
